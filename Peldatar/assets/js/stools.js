...
var STools = (function(){
    ...
    /**
     * MEgtisztítja a fölösleges kulcsoktól az objectet
     * @param {object} obj Az object, amiből törölni szeretnénk a megadott kulcsokat
     * @param  {...any} props paraméterlista, mely a tartalmazza a megtartható kucslcsokat
    ...
    return {
        ...
        templateEvalToDOMList, remainProps
    }
